...
<form method="post" id="verificationForm">
    ...
    <br><br>
    <input type="submit" class="btn btn-secondary me-2" value="Verify">

</form>

<p class="time"></p>

<button class="btn btn-secondary me-2" id="resendOtpVerification">Resend Verification OTP</button>
</div>
</div>
</div>
...
<script>
    ...
    $(document).ready(function(){
        $('#verificationForm').submit(function(e){
            ...
            $.ajax({
                url:"{{ route('website.verifiedOtp') }}",
                type:"POST",
                data: formData,
                success:function(res){
                    if(res.success){
                        alert(res.msg);
                        window.open("/website/login","_self");
                    }
                    else{
